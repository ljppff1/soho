 ...
 * 
 */
public class StaffTrajectoryActivity extends BaseActivity implements
	...
	public void init() {
		...
		sdDialog = new SDProgressDialog(StaffTrajectoryActivity.this);
		...
		mapconfig = SharedPreferencesConfig.config(StaffTrajectoryActivity.this);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 1:
			...
			pos = data.getStringExtra("usernamecode").trim();
	...
	public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(StaffTrajectoryActivity.this, "抱歉，未能找到结果",
	...
	public void onClick(View view) {
		...
		case R.id.searchLayout:
			...
			Intent intent = new Intent(StaffTrajectoryActivity.this,StaffTrajectorySearchActivity.class);
	...
	class loadThread implements Runnable{
		...
		public void run() {
			...
			if (!NetCheckUtil
					.isNetworkAvailable(StaffTrajectoryActivity.this)) {
				Toast.makeText(StaffTrajectoryActivity.this,
			...
			if(userList.size()!=0){
				params.add(new BasicNameValuePair("empId", pos));
			}
			try {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 6:
				Toast.makeText(StaffTrajectoryActivity.this, "网络异常", 1).show();
				break;
			case 7:
				Toast.makeText(StaffTrajectoryActivity.this, "请选择起始时间!", 1).show();
				break;
			}
		}
	};
			...
			listener = new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick() {
					try {
						...
						intent.setClass(StaffTrajectoryActivity.this,
	...
	public void showPostionInMap(List<AddressInfo> addList){
		if(addList.size()==0){
			Toast.makeText(StaffTrajectoryActivity.this, "记录为空!", Toast.LENGTH_SHORT)
			.show();
			return;
		}
...
//			marker.position(listLatlng.get(i));
//			marker.title("第"+i+"个");
			
//			mMarkerA = (Marker) mBaiduMap.addOverlay(new MarkerOptions().position(
//					listLatlng.get(i)).icon(
//					BitmapDescriptorFactory.fromResource(R.drawable.icon_marka)));
//			 mBaiduMap.addOverlay(marker);
	...
	public void onGetDrivingRouteResult(DrivingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(StaffTrajectoryActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
					.show();
		}
