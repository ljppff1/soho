...
//	private final static String HOME_URL = "http://192.168.0.117:8080"; //正式库
	private final static String HOME_URL = "http://192.168.0.132:8080"; //正式库
	//private final static String HOME_URL = "http://192.168.0.101:8080"; // 测试库
	//private final static String HOME_URL = "http://192.168.0.116:8080"; // 测试库
